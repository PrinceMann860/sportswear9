    ...
    <nav className="w-full bg-[#F4EFE7] border-b border-gray-200 fixed top-0 z-50">
      <div className="px-6 lg:px-10 mx-auto flex items-center justify-between py-3 lg:py-4 h-[60px]">
        ...
        <div className="flex items-center gap-8">
          <div className="text-xl font-bold tracking-tighter">SPORTSWEAR9</div>
      ...
      {open && (
        <div
          className={`fixed inset-0 bg-white z-50 flex flex-col p-6 transform transition-transform duration-1000 ease-in-out ${
        ...
        >
          ...
          <div className="flex flex-col space-y-6 text-lg">
            {["Home", "Men", "Women", "Kids", "Sports&Lifestyle", "Outlet"].map(
              (item) => (
