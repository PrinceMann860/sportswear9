  ...
  return (
    <main className="w-full bg-white pt-20 overflow-x-hidden animate-pulse">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 gap-4">
          {Array.from({ length: 8 }).map((_, index) => (
            <div key={index} className="flex flex-col items-center space-y-2">
              <div className="w-16 h-16 md:w-32 sm:h-32 lg:w-40 lg:h-40 rounded-lg bg-gray-300"></div>
      ...
      <div className="w-full max-w-full mx-auto p-5 lg:p-10 rounded-2xl overflow-hidden">
        <div className="w-full h-64 md:h-80 lg:h-96 bg-gray-300 rounded-xl"></div>
      </div>

      {/* Shop by Category Skeleton */}
      <div className="px-2 sm:px-4 md:px-6 lg:px-12 xl:px-16 max-w-full mb-12">
        <div className="h-4 w-40 bg-gray-300 rounded mb-4 mr-auto"></div>
        <div className="h-8 w-70 bg-gray-300 rounded mb-8 mr-auto"></div>
        <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-8 gap-4">
          {Array.from({ length: 8 }).map((_, index) => (
            <div key={index} className="flex flex-col items-center space-y-2">
              <div className="w-16 h-16 md:w-32 sm:h-32 lg:w-40 lg:h-40 rounded-lg bg-gray-300"></div>
      ...
      <div className="mb-12">
        ...
        <div className="flex space-x-4 overflow-hidden px-6">
      ...
      <div className="w-full px-2 sm:px-4 md:px-6 lg:px-12 xl:px-16 max-w-full mb-12">
      ...
      {/* Curated Deals Skeleton */}
      <section className="mt-5 p-5 px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto max-w-full mb-12">
      ...
      <section className="mt-12 sm:px-4 md:px-6 lg:px-12 xl:px-14 px-6 mx-auto max-w-full mb-12">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 xl:grid-cols-9 gap-4 sm:gap-6 max-w-full">
      ...
      <div className="px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto max-w-full mb-12">
      ...
      {/* New Arrivals & Trending Products Skeleton */}
      <section className="py-8 max-w-full">
        <div className="px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto max-w-full">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 py-6 mb-12">
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="w-full">
                <div className="w-full h-40 bg-gray-300 rounded-lg mb-2"></div>
                <div className="h-3 w-24 bg-gray-300 rounded mb-2"></div>
          ...
          <div className="w-full max-w-full md:h-[350px] bg-gray-300 rounded-lg mb-12"></div>
          ...
          <div className="py-10">
            ...
            <div className="h-10 w-24 bg-gray-300 rounded mx-auto"></div>
          </div>
        </div>
      </section>

      {/* Image Grid Skeleton */}
      <div className="px-2 sm:px-4 md:px-6 lg:px-12 mx-auto hover:shadow-lg lg:mt-10 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 lg:gap-6 w-full mb-10 overflow-hidden max-w-full">
        {Array.from({ length: 4 }).map((_, index) => (
