...
const sportsGearItems = [
  {
    name: "Golf",
    image: "https://media.istockphoto.com/id/171362434/photo/golfer-swinging-at-sunset.jpg?s=612x612&w=0&k=20&c=hqIIHoIH2IQ0EpWOSt98-J3KEiY_ISivbuA2T8pjYug=",
    link: "#",
  },
  {
    name: "Cricket Trousers",
    image: "https://ocs-sport.ams3.cdn.digitaloceanspaces.com/let/2015/06/reid762.jpg",
    link: "#",
  },
  {
    name: "Tennis",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS683LpVYvV2SaCQmycBNPxhx7YYLH9_HMKPQ&s",
    link: "#",
  },
  {
    name: "Basketball",
  ...
  {
    name: "GYM",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRM7keGEpuMGAMjwNg9YGQYY6ApcjcA3MoqkTc9DaBTZ29nUq7BiC3cC6PdOLrkA1UmKQ&usqp=CAU",
    link: "#",
  },
  {
    name: "Yoga",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQS0pUCsbpuq7EZNZ8t5vlenrjVYcmzSkLx6Q&s",
    link: "#",
  },
  {
    name: "Running",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5zLb3NX0iZN_-V8d1srf31bm22sftIO531Q&s",
    link: "#",
  },
];
...
function Home() {
  ...
  return (
    <main className="w-full bg-white pt-20">
      ...
      />
      <div className="w-full mx-auto p-5 lg:p-10 rounded-2xl">
        <LandscapeCarousel items={mainBanners} />
      </div>
      {/* Banner */}
      <AnimatedSection>
        <div className="px-2 sm:px-4 md-px-6 lg:px-12 xl:px-16">
          <CategoryGrid
            title="Shop by Category"
            subtitle="Find Your Perfect Gear"
      ...
      <AnimatedSection className="w-full px-2 sm:px-4 md:px-6 lg:px-12 xl:px-16">
      ...
      {/* Festive Deals */}
      <section className="mt-5 p-5 px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto">
      ...
      <section className="mt-12 sm:px-4 md:px-6 lg:px-12 xl:px-14 px-6 mx-auto">
      ...
      {/* Sports */}
      <section className=" mx-auto text-center px-2  sm:px-4 md:px-6 lg:px-12 xl:px-14">
        <h2 className="font-semibold text-xl md:text-4xl">
          Your Passion. Your Performance.
        </h2>
        <VideoGrid />
      </section>
      <div className="px-2 sm:px-4 md:px-6 lg:px-12 mx-auto">
        <DealsOfTheDay title="Shop Now: Deals of the Day" items={promoCards} />
      </div>

      {/* Product Section */}
      <section className="py-8">
        <div className="px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto">
        ...
        {/* <div className="w-[100vw] px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto pt-10 px-4 rounded-md md:rounded-xl">
          <LandscapeCarousel items={promoBanners} />
        </div> */}
        <div className="w-[100vw] px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto pt-10 rounded-md md:rounded-xl">
          <img
            src={ad3}
      ...
      {/* big banner */}
      <div className="px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto hover:shadow-lg lg:mt-10 transition cursor-pointer">
        <video
      ...
      {/* Customer Reviews */}
      <section className="px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto py-12">
      ...
      <section className="px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 w-full my-10 mx-auto">
        <ShopTheLookCarousel />
      </section>
      <ComingSoon />
      {/* Promo & Availability Section */}
      <section className="px-2 sm:px-4 md:px-6 lg:px-12 xl:px-14 mx-auto pt-12">
        {/* Discount Banner */}
        <div className="bg-[#fdf9f3] px-4 lg:px-0 border border-dashed border-blue-400 text-center py-4 rounded-md mb-10">
          <p className="lg:text-lg text-sm">
            Super discount for your{" "}
            <span className="font-semibold text-blue-500">first purchase.</span>{" "}
            <span className="inline-block mx-2 px-3 py-1 border-2 border-dashed border-blue-400 text-blue-500 font-bold rounded">
              FREE15FIRST
            </span>
        ...
        <div className="text-center lg:px-4 pt-10 lg:pb-10">
          ...
          <div className="flex items-center justify-evenly flex-wrap w-full my-10">
            <img
